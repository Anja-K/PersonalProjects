		               	...
		               	<div class="row">
		               		...
		               		<div class="col-md-3">
		               			<div class="text-center">
		               				...
		               				<form action="LogIn page-3/upload.php" method="post" enctype="multipart/form-data">
		               		...
		               		<div class="col-md-8 personal-info">
		               			...
		               			<h3>Personal Info</h3>
		               			<form  action="logIn page-3/update-profile.php" method="post" class="form-horizontal" role="form">

...
<head>
    <meta charset="UTF-8">
    <meta name="copyright" content="SEDC - '<?php echo date("Y"); ?>'" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <meta name="language" content="English" />
    <meta http-equiv="content-language" content="en" />
	<meta description="A beautiful modern Dashboard that is the ideal solution 
                        to manage your online statistics and information. The 
                        colorful interface gives a modern and refreshing look to 
                        catch your attention. This Dashboard is a stylish design with a celan look.
                        Download this Dashboard and you can start sorting your work. Made in 2017." />
    <meta name="keywords" content="dashboard, modern, color, colorful, statistics, clean, refreshing, html, javascript, css, php" />
    <title>Colorful Dashboard | Cool Design for your Dashboard - SEDC 2017</title>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" type="text/css" <?php if($scriptName == "uielements.php"){echo "href='css/alert-style.css'";} if($scriptName == "horizontaltimeline.php"){echo "href='css/style-horizontal-timelne.css'";}
    ?>>

    <?php 

        if($scriptName == "verticaltimeline.php"){
            echo '
        ...
        if($scriptName == "profile.php"){
           ...
           input[type=file]{
            ...
            .image-holder{
                width: 255px;
                height: 319px;
                background-image: url("loginpage/images/'.$image.'");
                    ...
                    <ul class="nav in" id="side-menu">
                        <li class="user-profile">
                            ...
                            <div class="user-profile-details">
                               ...
                               <img src="<?php echo 'loginpage/images/'.$image; ?>" class="img-circle img-responsive" alt="<?php echo 'Profile image of '. $fullname ;?>">
                        ...
                        <li class="dropdown-list-element">
                            ...
                            <ul class="nav nav-second-level">
                                <li>   
                                    <a href="verticaltimeline.php" <?php if($scriptName == "timeline.php"){echo 'class="active"';}?>>Vertical timeline</a>
                                </li>
                                <li>
                                    <a href="horizontaltimeline.php" <?php if($scriptName == "hor-timeline.php"){echo 'class="active"';}?>>Horizontal timeline</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                        ...
                        <li class="dropdown-list-element">
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="./loginpage/login.php" <?php if($scriptName == "login.php"){echo 'class="active"';}?>>Login Page</a>
                                </li>
                                <li>
                                    <a href="grid.php" <?php if($scriptName == "grid.php"){echo 'class="active"';}?>>Grid Page</a>
                                </li>
                                <li>
                                	<a href="./error404/error404.php" <?php if($scriptName == "error404.php"){echo 'class="active"';}?>>404 Error Page</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
